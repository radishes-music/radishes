<template>
  <div class="lycLayout">
    <img src="../assets/song/bg.jpg" class="blurBg">
    <span class="scaleMin" @click="back"><img src="../assets/song/Min.png"></span>
    <div class="songImg">
      <div>
...
::-webkit-scrollbar-track{background-color: rgb(200,200,200);}
::-webkit-scrollbar-thumb{background-color: rgb(245,245,245);}
::-moz-scrollbar{width:6px;height:4px}
::-moz-scrollbar-track{background-color: rgb(200,200,200);}
::-moz-scrollbar-thumb{background-color: rgb(245,245,245)}
...
.songImg {
  ...
  background: url(../assets/song/songImg.png) no-repeat center;
}
.songImg div {
  width: 216px;
  height: 216px;
