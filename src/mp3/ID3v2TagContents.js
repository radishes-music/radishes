  ...
  (function() {
    ...
    _createClass(ID3v2TagContents, [
      ...
      },
      {
        ...
        value: function setTagRestrictions(
          size,
          textEncoding,
          textSize,
          imageEncoding,
      ...
      },
      {
        ...
        value: function addFrame(id, data, flags, noFlagsDataLength) {
          ...
          if (this._major === 2) {
            ...
            if (flags) {
              frameFlags[0] |=
                (flags.message.tag_alter_preservation ? 1 : 0) << 7
              frameFlags[0] |=
                (flags.message.file_alter_preservation ? 1 : 0) << 6
            ...
            if (flags) {
              frameFlags[0] |=
                (flags.message.tag_alter_preservation ? 1 : 0) << 6
              frameFlags[0] |=
                (flags.message.file_alter_preservation ? 1 : 0) << 5
      ...
      },
      {
        ...
        value: function _setData(offset, data) {
          this._contents.splice.apply(
            this._contents,
            [offset, data.length].concat(data)
          )
        }
      },
      {
