...
var ArrayBufferFileReader =
  /*#__PURE__*/
  (function(_MediaFileReader) {
    _inherits(ArrayBufferFileReader, _MediaFileReader)

    function ArrayBufferFileReader(buffer) {
      var _this

      _classCallCheck(this, ArrayBufferFileReader)

      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(ArrayBufferFileReader).call(this)
      )
      ...
      [
        {
          ...
          value: function canReadFile(file) {
            return (
              typeof ArrayBuffer === 'function' && file instanceof ArrayBuffer
            )
          }
        }
      ]
